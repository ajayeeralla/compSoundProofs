...
Definition qa22 :=                                                                                                                                         (if_then_elsem_ ((EQM (reveal  x5) (i 1) ) & (EQM (to x2) (i 1)) &(EQM (to x1) (i 1)) & (notb (EQM ( act x2) new)) &(EQM (act x1) new))  (pi1  (dec x2 (sk (N 1)))) 
