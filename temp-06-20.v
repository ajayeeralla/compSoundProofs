...
pose proof (mor_eval_andB 8  (if_then_else_M(Bvar 2) O
      (if_then_else_M (Bvar 3) O
         (if_then_else_M (EQ_M (to x2) (i 1))
            (if_then_else_M (Bvar 5) O
               (if_then_else_M
                  ((((Bvar 4) & (EQ_M (to x2) (i 1))) &
                    (Bvar 8)) & (notb (EQ_M (act x2) new))) &
                  (Bvar 9)
                           ...
                           (if_then_else_M
                              ...
                              (if_then_else_M
                                 ((((Bvar 6) &
                                   ...
                                   (Bvar 8)) &
                                  (notb (EQ_M (act x2) new))) &
                                 (Bvar 9) mx2rn1 O))) O))) O))))   (if_then_else_M (EQ_M (to x1) (i 1))
      (if_then_else_M (Bvar 3) O
         (if_then_else_M(Bvar 2) & (EQ_M (to x1) (i 1))
            (if_then_else_M (Bvar 5) O
                                 ...
                                 (if_then_else_M
                                    ...
                                    (if_then_else_M
                                       ((((Bvar 6) &
                                         ...
                                         (EQ_M (to x1) (i 1))) &
                                        (notb (EQ_M (act x2) new))) &
                                       (EQ_M (act x1) new) mx2rn1 O))) O))) O)))
            O)))).simpl in H.

rew_andB_elm_in_msg H.
simpl in H. rew_IFTF_all_in H.

rew_eval_in_bol H. 

 rew_IFTF_in  (if_then_else_B 
                                         (Bvar 4) (EQ_M (to (f mphi1)) (i 1))
                                         FAlse)  H.
...
apply Forall_ELM_EVAL_B with (n:=3) (b:=   (if_then_else_B 
                                         (Bvar 4) (EQ_M (to (f mphi1)) (i 1))
                                         FAlse) ) in H0. simp_in  H0;  rew_clear_in H0 H. 
pose proof(IFTF 3);apply Forall_ELM_EVAL_B with (n:=3) (b:=  (if_then_else_B
                                  (EQ_M (reveal (f mphi2)) (i 1))
                                  (EQ_M (to (f mphi1)) (i 1)) FAlse)) in H;simp_in  H; rew_clear H.
                                 ...
                                 (if_then_else_M
                                    ...
                                    (if_then_else_M
                                       ((((Bvar 6) &
                                        ...
                                        (notb (EQ_M (act x2) new))) &
                                       (Bvar 9) mx2rn1 O))))) O)))
               O)))))   (if_then_else_M (EQ_M (to x1) (i 1))
      (if_then_else_M (Bvar 3) O
         (if_then_else_M(Bvar 2) & (EQ_M (to x1) (i 1))
            (if_then_else_M (Bvar 5) O
               (if_then_else_M (EQ_M (to x3) (i 2)) & (EQ_M (act x3) new)
